...
impl Langue {
    pub fn depuis_code(code: &str) -> Self {
        match code {
            "en" => Self::Anglais, "es" => Self::Espagnol,
            "mos" | "moore" => Self::Moore, "gur" | "gurunsi" => Self::Gurunsi,
            "la" | "lat" => Self::Latin, _ => Self::Francais,
        }
    }
...
pub fn obtenir_traduction(cle: &CleTraduction, langue: &Langue) -> &'static str {
    match (cle, langue) {
        ...
        (CleTraduction::Arret, Langue::Anglais) => "Gideonne is stopping.",
        ...
        (CleTraduction::PluginCharge, Langue::Francais) => "Plugin chargé avec succès.",
