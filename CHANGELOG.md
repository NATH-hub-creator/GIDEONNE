...
### Ajouté
- Scaffold complet du projet Gideonne_1 (57 fichiers)
...
### Technique
- Rust edition 2021
- Tauri v2 avec fenêtre 1100x720, mode sombre activé
- React 18 + TypeScript + Vite + Zustand + i18next
- SQLite via rusqlite pour la persistance locale
- Chiffrement AES-256-GCM via crate `aes-gcm`
